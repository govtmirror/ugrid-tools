...
PATH_CATCHMENT_SHP = '/home/benkoziol/Dropbox/NESII/project/nfie/bin/NHDPlusTX/NHDPlus12/NHDPlusCatchment/Catchment.shp'
# DIR_OUTPUT = tempfile.mkdtemp()
PATH_CLIMATE_DATA = '/home/benkoziol/htmp/nfie/nldas_met_update.obs.daily.pr.1990.nc'
...
DIR_OUTPUT = os.path.expanduser('~/htmp/nfie')
...
def add_unique_identifier():
    in_path = os.path.expanduser('~/htmp/nfie/catchment_singlepart_with_uid.shp')
    out_path = os.path.expanduser('~/htmp/nfie/catchment_singlepart_with_uid2.shp')
